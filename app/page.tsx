    ...
    <div className="min-h-screen bg-black">
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-24">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-zinc-200 max-w-4xl mx-auto mb-12 leading-relaxed">
          ...
          <p className="text-base text-zinc-400 max-w-3xl mx-auto mb-16 leading-relaxed">
