    ...
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black py-8">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="mb-12"
        >
          <h1 className="text-5xl font-bold mb-4 font-orbitron text-center bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text text-transparent">
            INFORMATION CENTER
          </h1>
        ...
        >
          <Card className="bg-gray-900/80 border-gray-800">
            <CardHeader>
              <CardTitle className="flex items-center gap-3 text-2xl font-orbitron text-yellow-400">
          ...
          <Card className="bg-gray-900/80 border-gray-800">
            <CardHeader>
              <CardTitle className="flex items-center gap-3 text-2xl font-orbitron text-cyan-400">
            ...
            <CardContent className="space-y-4 text-gray-300">
              ...
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="energy" className="border-gray-700">
                ...
                <AccordionItem value="crater" className="border-gray-700">
                  <AccordionTrigger className="text-white hover:text-blue-400">
          ...
          <Card className="bg-gray-900/80 border-gray-800">
            <CardHeader>
              <CardTitle className="flex items-center gap-3 text-2xl font-orbitron text-green-400">
          ...
          <Card className="bg-gray-900/80 border-gray-800">
            <CardHeader>
              <CardTitle className="flex items-center gap-3 text-2xl font-orbitron text-blue-400">
          ...
          <Card className="bg-gray-900/80 border-gray-800">
            <CardHeader>
              <CardTitle className="flex items-center gap-3 text-2xl font-orbitron text-purple-400">
            ...
            <CardContent className="space-y-4 text-gray-300">
              <ol className="list-decimal list-inside space-y-3">
                <li className="text-white">
                  ...
                  <p className="ml-6 mt-1 text-gray-300 text-sm">
